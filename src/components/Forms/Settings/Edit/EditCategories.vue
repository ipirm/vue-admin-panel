<template>
    <div class="form-container">
        ...
        <base-button @click.native="addUpdateCategories" class="button-add" long>Add</base-button>
    </div>
</template>
...
<script>
    ...
    export default {
        ...
        computed: {
            ...
            ...mapState('settings', ['setting','categoriesList','categoriesValues']),
        ...
        methods: {
            ...mapActions('settings', ['fetchSettingsCore','updateSetting','updateCategories']),
