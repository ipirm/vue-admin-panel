<template>
    <div class="form-container">
        ...
        <base-button @click.native="addUpdateCategory" class="button-add" long>Add</base-button>
    </div>
</template>
...
//            this.parent_category_id = this.category.parent_category_id
            ...
            this.$store.state.childs.categoriesCore.forEach(element => {


                if (element.id == compContext.$route.params.id) {
...
//            this.description = this.category.description
        ...
        methods: {
            ...
            ...mapActions('childs', ['fetchCategoriesCore','createCategory']),
            ...
            addUpdateCategory() {
                ...
                const category = {
                    ...
                    parent_category_id: this.$route.params.id,
