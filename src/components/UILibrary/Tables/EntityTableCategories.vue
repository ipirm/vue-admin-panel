        ...
        <div class="table">
            ...
            <div class="table-items">
                <transition-group name="fade" tag="div">
                    <div v-for="(item, key) in filterCategories" :key="key + 0" class="table-item">
                        ...
                        <div class="field name">
                            <router-link :to="'categories-childs/' + item.id">
                                {{ item.name }}
                            </router-link>
                        </div>
                        <div class="field parent_category_id"> {{ item.parent_category_id ? item.parent_category_id : '-' }} </div>
                        <div class="field actions">
                            ...
                            <div class="action" @click="$emit('delete-category', item)">
...
<script>
    ...
    export default {
        data() {
            return {
                ...
                tableHead: [
                    ...
                    { class: 'parent_category_id', name: 'Parent Category Id', active: false },
        ...
        computed: {
            ...mapState('categories', ['filterCategories'])
        },

        watch: {
            checkAll() {
                this.checkedItemIds = this.checkAll ? this.filterCategories.map(item => item.id) : []
            }
        },
