        ...
        <div class="table">
            ...
            <div class="table-items">
                <transition-group name="fade" tag="div">
                    <div v-for="(item, key) in filterTexts" :key="key + 0" class="table-item">
                        ...
                        <div class="field actions">
                            <router-link :to="'text-pages/' + item.id">
                                <div class="action">
                                    <svg-icon class="icon-action" name="act_edit" />
                                </div>
                            </router-link>

                            <div class="action" @click="$emit('delete-text', item)">
...
<script>
    ...
    export default {
        ...
        computed: {
            ...mapState('texts', ['filterTexts'])
        },

        watch: {
            checkAll() {
                this.checkedItemIds = this.checkAll ? this.filterTexts.map(item => item.id) : []
            }
        },
