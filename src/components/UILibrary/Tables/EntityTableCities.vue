        ...
        <div class="table">
            ...
            <div class="table-items">
                <transition-group name="fade" tag="div">
                    <div v-for="(item, key) in filterCities" :key="key + 0" class="table-item">
                        ...
                        <div class="field actions">
                            <router-link :to="'cities/' + item.id">
                                <div class="action">
                                    <svg-icon class="icon-action" name="act_edit" />
                                </div>
                            </router-link>

                            <div class="action" @click="$emit('delete-city', item)">
...
<script>
    ...
    export default {
        ...
        computed: {
            ...mapState('cities', ['filterCities'])
        },

        watch: {
            checkAll() {
                this.checkedItemIds = this.checkAll ? this.filterCities.map(item => item.id) : []
            }
        },
