        ...
        <div class="table">
            ...
            <div class="table-items">
                <transition-group name="fade" tag="div">
                    <div v-for="(item, key) in filterCountries" :key="key + 0" class="table-item">
                        ...
                        <div class="field actions">
                            ...
                            <div class="action" @click="$emit('delete-country', item)">
...
<script>
    ...
    export default {
        ...
        computed: {
            ...mapState('countries', ['filterCountries'])
        },

        watch: {
            checkAll() {
                this.checkedItemIds = this.checkAll ? this.filterCountries.map(item => item.id) : []
            }
        },
