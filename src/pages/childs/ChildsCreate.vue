...
<script>
    ...
    import AddCategory from '@/components/Forms/Childs/Add/AddChild'
    ...
    export default {
        ...
        data: () => ({
            breadcrumbs: [
                ...
                { pathname: "child-create", title: 'Add Child category' }
            ],
            tabComponent: 'AddCategory'
        }),
        created() {
            this.fetchCategoriesCore()
        },
        methods: {
            ...mapActions('categories', ['fetchCategoriesCore']),
        },
    }
</script>
