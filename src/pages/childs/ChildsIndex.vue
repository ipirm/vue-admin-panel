<template>
    <div class="card-page">
        ...
        <alert-info
                text="Manage child categories"
                button="Add Categories"
                @buttonClick="$router.push('/categories-childs/' + $route.params.id + '/new')" />
...
<script>
    ...
    import EntityTable from '@/components/UILibrary/Tables/EntityTableChilds'
    ...
    export default {
        ...
        methods: {
            ...
            ...mapActions('childs', ['getFilterCategories', 'deleteCategory']),
            ...
            get() {
                this.getFilterCategories(this.$route.params.id)
            }
        }
    }
</script>
