<template>
    <div class="card-page">
        ...
        <alert-info
                text="Manage Cities"
                button="Add City"
                @buttonClick="$router.push('/cities/new')" />
        ...
        <entity-table @delete-city="deleteCityEmit" @click-arrow="onSort" />

        <div class="pagination-cont">
            <pagination-table :meta="citiesMeta" @paginate="paginate" />
        </div>

        <base-modal :active="activeModal" @close="activeModal = false">
            <div class="confirmation">Confirmation</div>
            <div class="question">Are you sure to delete a city?</div>
...
<script>
    ...
    import EntityTable from '@/components/UILibrary/Tables/EntityTableCities'
    ...
    export default {
        ...
        computed: {
            ...mapState('ui', ['loading']),
            ...mapState('cities', [ 'citiesMeta'])
        },
        methods: {
            ...mapActions('cities', ['getFilterCities', 'deleteCity']),
            ...
            get() {
                this.getFilterCities(this.queryParams)
            }
        }
    }
</script>
