<template>
    <div class="card-page">
        ...
        <alert-info
                text="Manage types"
                button="Add Types"
                @buttonClick="$router.push('/product-types/new')" />
        ...
        <entity-table @delete-type="deleteTypeEmit" @click-arrow="onSort" />
...
<script>
    ...
    import EntityTable from '@/components/UILibrary/Tables/EntityTableTypes'
    ...
    export default {
        ...
        computed: {
            ...
            ...mapState('types', [ 'typesMeta'])
        },
        methods: {
            ...mapActions('users', ['getFilterUsers', 'deleteUser']),

            ...mapActions('types', ['getFilterTypes', 'deleteType']),
            ...
            get() {
                this.getFilterTypes(this.queryParams)
            }
        }
    }
</script>
