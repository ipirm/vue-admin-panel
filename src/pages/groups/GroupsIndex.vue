<template>
    <div class="card-page">
        ...
        <h1>Manage Group of Countries</h1>
        <alert-info
                text="Manage Group of Countries"
                button="Add Group Countries"
                @buttonClick="$router.push('/group-of-countries/new')" />
        ...
        <entity-table @delete-group="deleteGroupEmit" @click-arrow="onSort" />
        ...
        <base-modal :active="activeModal" @close="activeModal = false">
            ...
            <div class="question">Are you sure to delete a group of countries?</div>
...
<script>
    ...
    import EntityTable from '@/components/UILibrary/Tables/EntityTableGroups'
    ...
    export default {
        ...
        data: () => ({
            ...
            breadcrumbs: [
                ...
                { pathname: "group-index", title: 'Group of countries' }
            ],
            queryParams: {},
            activeModal: false,
            deleteName: null,
        ...
        computed: {
            ...
            ...mapState('groups', [ 'groupsMeta'])
        },
        methods: {
            ...mapActions('groups', ['getFilterGroups', 'deleteGroup']),

            deleteGroupEmit(item) {
            ...
            get() {
                this.getFilterGroups(this.queryParams)
            }
        }
    }
</script>
