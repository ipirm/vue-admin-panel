...
<script>
    ...
    import AddGroup from '@/components/Forms/Groups/Add/AddGroup'
    ...
    export default {
        ...
        data: () => ({
            breadcrumbs: [
                ...
                { pathname: "group-index", title: 'Groups of Countries' },
                { pathname: "group-create", title: 'Add group of countries' }
            ],
            tabComponent: 'AddGroup'
        }),
        methods: {
        }
    }
