<template>
    <div class="card-page">
        ...
        <h1>Manage Text Pages</h1>
        <alert-info
                text="Manage text pages"
                button="Add Text Page"
                @buttonClick="$router.push('/text-pages/new')" />
        ...
        <entity-table @delete-text="deleteTextEmit" @click-arrow="onSort" />

        <div class="pagination-cont">
            <pagination-table :meta="textsMeta" @paginate="paginate" />
        </div>

        <base-modal :active="activeModal" @close="activeModal = false">
            <div class="confirmation">Confirmation</div>
            <div class="question">Are you sure to delete a text pages?</div>
...
<script>
    ...
    import EntityTable from '@/components/UILibrary/Tables/EntityTableTexts'
    ...
    export default {
        ...
        computed: {
            ...mapState('ui', ['loading']),
            ...mapState('texts', [ 'textsMeta'])
        },
        methods: {
            ...mapActions('texts', ['getFilterTexts', 'deleteText']),
            ...
            get() {
                this.getFilterTexts(this.queryParams)
            }
        }
    }
</script>
