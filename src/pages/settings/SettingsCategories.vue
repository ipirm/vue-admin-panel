...
<script>
    import EditCategories from '@/components/Forms/Settings/Edit/EditCategories.vue'
    ...
    export default {
        ...
        data: () => ({
            breadcrumbs: [
                ...
                { pathname: "setting-categories", title: 'Edit setting categories' }
            ],
        ...
        methods: {
            ...mapActions('settings', ['getSetting','getCategoriesList','getCategoriesValues']),
        },
    }
</script>
