<template>
    <div class="card-page">
        ...
        <alert-info
                ...
                button="Add Settings"
                @buttonClick="$router.push('/product-setting-types/new')" />
        ...
        <entity-table @delete-setting="deleteSettingEmit" @click-arrow="onSort" />
        ...
        <base-modal :active="activeModal" @close="activeModal = false">
            ...
            <div class="question">Are you sure to delete a type?</div>
...
<script>
    ...
    import EntityTable from '@/components/UILibrary/Tables/EntityTableSettings'
    ...
    export default {
        ...
        computed: {
            ...
            ...mapState('settings', [ 'settingsMeta'])
        },
        methods: {
            ...mapActions('settings', ['getFilterSettings', 'deleteSetting']),

            deleteSettingEmit(item) {
            ...
            modalClickDelete() {
                this.deleteSetting(this.deleteId)
            ...
            get() {
                this.getFilterSettings(this.queryParams)
            }
        }
    }
</script>
