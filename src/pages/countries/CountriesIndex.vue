<template>
    <div class="card-page">
        ...
        <alert-info
                ...
                @buttonClick="$router.push('/countries/new')" />
        ...
        <entity-table @delete-country="deleteCountryEmit" @click-arrow="onSort" />

        <div class="pagination-cont">
            <pagination-table :meta="countriesMeta" @paginate="paginate" />
        </div>

        <base-modal :active="activeModal" @close="activeModal = false">
            <div class="confirmation">Confirmation</div>
            <div class="question">Are you sure to delete a country?</div>
...
<script>
    ...
    import EntityTable from '@/components/UILibrary/Tables/EntityTableCountries'
    ...
    export default {
        ...
        computed: {
            ...mapState('ui', ['loading']),
            ...mapState('countries', [ 'countriesMeta'])
        },
        methods: {
            ...mapActions('countries', ['getFilterCountries', 'deleteCountry']),

            deleteCountryEmit(item) {
            ...
            get() {
                this.getFilterCountries(this.queryParams)
            }
        }
    }
</script>
