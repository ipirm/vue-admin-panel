<template>
  <div class="card-page">
    ...
    <h1>Manage Users</h1>
    <alert-info 
      text="Manage users by controlling who has access to what products and tabs within the Booking Tours Management Center."
      button="Add User"
      @buttonClick="$router.push('/users/new')" />
    ...
    <entity-table @delete-user="deleteUserEmit" @click-arrow="onSort" />
...
import EntityTable from '@/components/UILibrary/Tables/EntityTableUsers'
...
export default {
  ...
  methods: {
    ...
    deleteUserEmit(item) {
      this.deleteName = item.profile.full_name
    ...
    get() {
      this.getFilterUsers(this.queryParams)
    }
  }
}
</script>
